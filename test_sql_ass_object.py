...
print ("Products array of order1: ",order1.products)
print ("Products array of order3: ",order2.products)
print ("Orders array of prod1: ",prod1.orders)
print ("Orders array of prod2: ",prod2.orders)
print ("Orders array of prod3: ",prod3.orders)
print ("Orders array of prod4: ",prod4.orders)

print ("Order_Products Array of order1 : ",order1.order_products)

print ("Order_Products Array of prod1 : ",prod1.order_products)
